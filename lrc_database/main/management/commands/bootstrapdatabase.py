...
def create_tutoring_shifts(shift_count: int):
    ...
    for _ in range(shift_count):
        ...
        TutoringShift.objects.create(
            tutor=tutor, location=location, start=start, duration=duration
        )
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        create_superuser(options["superuser_username"], options["superuser_password"], options["superuser_email"])
